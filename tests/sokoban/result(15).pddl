(define (problem Sokoban)
		(:domain sokoban)
		(:objects C0 D0 E0 F0 C1 D1 E1 F1 A2 B2 C2 D2 E2 F2 A3 B3 C3 D3 E3 F3 G3 H3 A4 B4 C4 D4 E4 F4 G4 H4 A5 B5 C5 D5 E5 F5 G5 H5 B6 C6 D6 E6 F6 G6 H6 C7 D7 E7 F7 C8 D8 E8 F8 - position agent - guard)
		(:INIT  (isWall C0) (isWall D0) (isWall E0) (isWall F0) (isWall C1) (isWall F1) (isWall A2) (isWall B2) (isWall C2) (isWall F2) (isWall A3) (isWall F3) (isWall G3) (isWall H3) (isWall A4) (isWall H4) (isWall A5) (isWall B5) (isWall H5) (isWall B6) (isWall C6) (isWall F6) (isWall G6) (isWall H6) (isWall C7) (isWall F7) (isWall C8) (isWall D8) (isWall E8) (isWall F8)
 (at agent E2)
 (isBox D3) (isBox E3) (isBox D4) (isBox E6)
 ...
 (gauche D7 E7) (droite E7 D7)
		...
		(:goal (AND (isBox C3) (isBox D3) (isBox E4) (isBox F4)))
)
